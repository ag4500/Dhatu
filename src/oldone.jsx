...
const HeroSection = () => {
    return <div className="relative w-full max-w-full mx-auto">
        ...
        <img
            ...
            alt="Hero"
            className="w-full h-[210px] sm:h-[572px]"
        ...
        <div className="opacity-100 text-[#242424] px-4 sm:px-[103px] absolute top-0 left-0 w-full h-full flex flex-col justify-center items-start">
            ...
            >
                ...
                <h1 className="font-cinzel font-normal text-left mb-4 text-[16px] leading-[22px] sm:text-[48px] sm:leading-[68px] sm:font-cinzel">
                    Taste the difference!
                </h1>

            </div>
            <p
                className="font-poppins text-[14px] leading-[19px]  text-left mb-[6px] sm:text-[18px] font-light sm:leading-[27px] sm:my-12 w-[200px]  sm:max-w-[641px] sm:w-full"
                // style={{
                //     maxWidth: '641px',
                //     // maxHeight: '54px',
                //     // marginTop: '51px',
            ...
            <button
                className="text-xs h-6 sm:h-11 sm:text-xl flex items-center justify-center border-[#242424] border text-[#242424] font-poppins text-[16px] font-normal leading-[24px]"
                style={{
                    maxWidth: '127px',
                    // height: '44px',
                    gap: '24px',
...
const MetalButtons = () => {
    ...
    return <div className="mt-8 text-[#242424]">
        <p className='text-[#787878] font-poppins text-[16px] font-normal leading-[60px] text-center'>Shop By</p>
        <p className="font-cinzel text-[38px] font-normal leading-[60px] text-center">
            METALS
        </p>
...
const ProductCard = () => {
    return (
        <div className="max-w-sm relative group">
            <div className="rounded-lg shadow-lg overflow-hidden bg-[#F7F7F7] h-[413px] flex items-center justify-center">
                <img
                    className="max-w-full max-h-full object-contain mx-9"
            ...
            <div className="p-4">
                <p className="font-poppins text-[24px] font-light leading-[36px] text-[#242424] text-left">
                    Product Name
                </p>
                <div className="flex justify-between items-center">
                    <p className="font-poppins text-[20px] font-medium leading-[30px] text-left text-[#242424]">
                        ₹ 580
                    </p>
...
const TrendingProducts = () => {
    return <div className="mt-24 text-[#242424]">
        <p className='text-[#787878] font-poppins text-[16px] font-normal leading-[60px] text-center'>Popular Products</p>
        <p className="font-cinzel text-[38px] font-normal leading-[60px] text-center">
            Trending Now
        </p>
...
const WhyChooseUs = () => {
    ...
    return <div className="mt-24 text-[#242424]">
        <p className='text-[#787878] font-poppins text-[16px] font-normal leading-[60px] text-center'>Best in Business  </p>
            ...
            <div className='flex flex-wrap gap-10 justify-center w-full pb-[50px] mx-4 sm:m-[unset]'>
                {type.map((i, idx) =>
                    ...
                    >
                        ...
                        <div className='py-4'>
                            <p className="font-cinzel text-[14px] sm:text-[24px] font-normal sm:leading-[40px] text-left text-[#242424]">

                                {i.title}</p>
                        </div>
                        <div className=''>
                            <p className="font-cinzel  text-[14px] sm:text-[16px] font-normal sm:leading-[28px] text-left text-[#242424]">
                                {i.des}</p>
                        </div>
                    </div>
                )}
...
const Footer = () => {
    ...
    return <div className="mt-24 text-[#242424]  bg-[#faf5f1]  border-[#E1DCD8] py-11" style={{ borderWidth: '1px' }}>

        <div className='flex flex-wrap flex-col items-center justify-between'>

            <div className='flex flex-wrap gap-10 justify-center w-full pb-[50px]'>
                {footer.map((i, idx) =>
                    <div key={idx} className="gap-10 sm:w-[100%] md:w-[400px] lg:w-[287px]"
                        style={{
                            height: 'auto', // Height adjusts based on content
